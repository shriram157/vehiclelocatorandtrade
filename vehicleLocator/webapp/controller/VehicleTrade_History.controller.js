...
var Accepted=i18n.getText("Accepted"); 
			...
			/*	arrData[i].zzsuffix = arrData[i].zzsuffix + "-" + arrData[i].suffix_desc_en;*/
				...
				row += '="' + arrData[i].Trade_Id + '","' + arrData[i].Trade_Status + '","' +RequestingDealerVisible+
					'",="' + DelearData + '",="' + arrData[i].VTN + '",="' + 	arrData[i].Model  + '","' + arrData[i].Suffix +
					'","' + arrData[i].APX +
					'","' + arrData[i].Ext_Colour + '","' + arrData[i].Changed_on + '",';
				//}
